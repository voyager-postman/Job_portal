        ...
        <div className="responsive-content">
          ...
          <div className="dashboard-stats-grid">
            <a
              ...
              href="/jobPortal/manage-job-application?tab=applications"
            >
            ...
            <a
              className="metric-card-modern"
              href="/jobPortal/manage-job-application?tab=saved-jobs"
            >
              <div className="metric-icon-box">
            ...
            <a
              className="metric-card-modern"
              href="/jobPortal/manage-job-application?tab=job-alerts"
            >
              <div className="metric-icon-box">
            ...
            <a
              className="metric-card-modern"
              href="/jobPortal/chat-messaging-system"
            >
              <div className="metric-icon-box">
            ...
            <a
              className="metric-card-modern"
              href="/jobPortal/activity-timeline"
            >
              <div className="metric-icon-box">
            ...
            <a
              className="metric-card-modern"
              href="/jobPortal/manage-job-application?tab=profile-views"
            >
              <div className="metric-icon-box">
